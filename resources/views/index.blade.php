...
<html class="no-js" lang="en">
  <head>
    ...
    <!--====== Title ======-->
    <title>Basic - The Complete Ecommerce and Retail Business Solution</title>
              ...
              <nav class="navbar navbar-expand-lg">
                ...
                <!-- <div class="navbar-btn d-none d-sm-inline-block">
                  <a class="main-btn" data-scroll-nav="0" href=""
                    >Admin Login</a
                  >
                  <a class="btn btn-secondary" data-scroll-nav="0" href=""
                    >User Login</a
                  >
                </div> -->
              </nav>
            ...
            <div class="col-lg-8">
              <div class="header-hero-content text-center">
                ...
                <h2
                  ...
                  data-wow-delay="0.5s"
                >
                  The Complete Ecommerce and Retail Business Solution
                </h2>
                <h5
                  ...
                  data-wow-delay="0.8s"
                >
                  Synchronize your inventory and sales at website, social media
                  and retail store from a single integrated platform.
                </h5>
                <p
                  class="text wow fadeInUp"
                  data-wow-duration="1.3s"
                  data-wow-delay="0.8s"
                >
                  Try Basic free for 14 days and explore all the features and
