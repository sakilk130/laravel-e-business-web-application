...
<div class="main-container">
    <div class="pd-ltr-20" style="width: 1540px;">
      <div class="card-box mb-30">
        <h2 class="h4 pd-20 text-blue">In Process Orders</h2>
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td style="background-color:yellow; border: none; color: black; padding: 15px 10px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px;" >{{ $order[$i]->status }}</td>
                <td>
                    <a class="btn btn-sm btn-info" href="{{route('admin.edit_in_process_orders', $order[$i]->id)}}">Edit</a>
                </td>
              </tr>
            @endfor
          </tbody>
