                    ...
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" action="" >
                            <div class="form-group">
                                ...
                                <input type="text" name="cu_name"  placeholder="Your Name"/>
                            </div>
                            <div class="form-group">
                                <label for="cu_email"><i class="zmdi zmdi-email"></i></label>
                                <input type="email" name="cu_email"  placeholder="Your Email"/>
                            </div>
                            <div class="form-group">
                                <label for="cu_pass"><i class="zmdi zmdi-lock"></i></label>
                                <input type="password" name="cu_pass" " placeholder="Password"/>
                            </div>
                            <div class="form-group">
                                <label for="re-pass"><i class="zmdi zmdi-lock-outline"></i></label>
                                <input type="password" name="cu_re_pass"  placeholder="Repeat your password"/>
                            </div>
                            <div class="form-group">
