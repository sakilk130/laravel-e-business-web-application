...
<body>
	...
	<script type="/assets/customer/text/javascript" src="http://maps.google.com/maps/api/js?sensor=true"></script>
    <script type="/assets/customer/text/javascript" src="js/gmaps.js"></script>
	<script src="/assets/customer/js/contact.js"></script>
